package com.mysite.restaurant.hj.security;
...
public class JwtTokenProvider {
    ...
    public String generateToken(UserEntity userEntity) {
        List<UserAuthEntity> userAuths = userMapper.findUserAuth(userEntity.getUserId());
        List<String> authorities = userAuths.stream()
                .map(UserAuthEntity::getAuth) // UserAuthEntity에서 auth를 추출
